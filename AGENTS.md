...
If the skill does not auto-trigger, point the user at [docs/STEEP-AS-CODE.md](docs/STEEP-AS-CODE.md) or `@` that file in chat. Index: [docs/README.md](docs/README.md).
